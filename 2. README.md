...
This repository contains the following files:
 ...
 smart_finance_project
 
 tavavasche_chiunzi_diary
 
 sample_transactions
 
 Savings_Assistant_Tester
...
1. LICENSE
2. README
3. smart_finance_project
4. tavavashe_chiunzi_diary
5. sample_transactions
6. AI-CONVERSATIONS
7. Savings_Assistant_Tester (This is where I was testing my code; it is NOT the final project)
8. starter_notebook (this is the final project)
